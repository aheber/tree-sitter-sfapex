...
enum ts_symbol_identifiers {
  ...
  sym_comparable_list = 191,
  sym_soql_with_clause = 192,
  sym_soql_with_type = 193,
  sym_with_user_id_type = 194,
  sym_with_record_visibility_expression = 195,
  sym_with_record_visibility_param = 196,
  sym_with_data_cat_expression = 197,
  sym_with_data_cat_filter = 198,
  sym_with_data_cat_filter_type = 199,
  sym_limit_clause = 200,
  sym_offset_clause = 201,
  sym_update_clause = 202,
  sym_update_type = 203,
  sym_alias_expression = 204,
  sym_order_by_clause = 205,
  sym_order_expression = 206,
  sym_order_direction = 207,
  sym_order_null_direction = 208,
  sym_geo_location_type = 209,
  sym__value_expression = 210,
  sym_function_expression = 211,
  sym_dotted_identifier = 212,
  sym_field_identifier = 213,
  sym_field_list = 214,
  sym_boolean = 215,
  sym_value_comparison_operator = 216,
  sym_set_comparison_operator = 217,
  sym_date_literal = 218,
  sym_date_literal_with_param = 219,
  sym__function_name = 220,
  sym_null_literal = 221,
  sym__soql_literal = 222,
  aux_sym_sosl_query_body_repeat1 = 223,
  aux_sym_sosl_query_body_repeat2 = 224,
  aux_sym_returning_clause_repeat1 = 225,
  aux_sym_selected_fields_repeat1 = 226,
  aux_sym_type_of_clause_repeat1 = 227,
  aux_sym__group_by_expression_repeat1 = 228,
  aux_sym_for_clause_repeat1 = 229,
  aux_sym_having_and_expression_repeat1 = 230,
  aux_sym_having_or_expression_repeat1 = 231,
