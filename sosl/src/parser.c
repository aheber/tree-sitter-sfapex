...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 513:
      if (lookahead == 'Q' ||
          lookahead == 'q') ADVANCE(685);
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(294);
      END_STATE();
    case 514:
      if (lookahead == 'Q' ||
          lookahead == 'q') ADVANCE(686);
      if (lookahead == 'Y' ||
    ...
    case 720:
      ...
      END_STATE();
    case 721:
      if (('0' <= lookahead && lookahead <= '2')) ADVANCE(22);
      END_STATE();
    case 722:
